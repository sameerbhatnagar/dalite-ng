    ...
    return regenerator.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            data = _context2.sent;
            model$1.reputation = data.reputation;
            model$1.reputations = data.reputations;
            console.log(model$1.reputations);
...
function toggleReputationList$1() {
  model$1.reputationListOpen = !model$1.reputationListOpen;
