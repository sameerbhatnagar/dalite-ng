...
var StudentReputationHeader =
/*#__PURE__*/
function (_ReputationHeader) {
  _inherits(StudentReputationHeader, _ReputationHeader);

  function StudentReputationHeader() {
    _classCallCheck(this, StudentReputationHeader);

    return _possibleConstructorReturn(this, _getPrototypeOf(StudentReputationHeader).apply(this, arguments));
  }

  _createClass(StudentReputationHeader, [{
    key: "init",
    value: function () {
      var _init = _asyncToGenerator(function* (shadow) {
        ...
        function iconView() {
          var icon = model.shadow.querySelector("#icon");
          ...
          if (!icon) {
            ...
            var symbol = createSvg("donut_small", false);
            symbol.id = "icon__icon";
            icon.appendChild(symbol); // $FlowFixMe
        ...
        function listView() {
          var list = model.shadow.querySelector("#list");
        ...
        function progressView(reputation) {
        ...
        function desktopProgressView(reputation) {
          var container = document.createElement("div");
          container.classList.add("badge");
          var width = Math.max.apply(Math, _toConsumableArray(reputation.badgeThresholds));
          var svg = select(container).append("svg").attr("viewBox", "0 0 200 40").append("g");
          svg.append("text").attr("data-val", reputation.reputation).attr("dominant-baseline", "central").attr("x", 10).attr("y", 20).attr("class", "fill-primary badge__reputation").attr("font-size", 16).text(0);
          svg.append("rect").attr("x", 40).attr("y", 12).attr("height", 16).attr("width", 150).attr("rx", 8).attr("ry", 8).attr("stroke", "var(--reputation-colour)").attr("stroke-width", 1).attr("fill", "none");
          svg.append("rect").attr("class", "badge__bar").attr("x", 40).attr("y", 12 + Math.max(0, 8 - Math.sqrt(16 * (150 * reputation.reputation / width)) / 2)).attr("height", Math.min(Math.sqrt(16 * (150 * reputation.reputation / width)), 16)).attr("rx", 8).attr("ry", 8).attr("stroke", "var(--reputation-colour)").attr("stroke-width", 1).attr("fill", "var(--reputation-colour)");
          reputation.badgeThresholds.forEach(function (threshold) {
            var badge = svg.append("g");
            badge.append("path").attr("d", "M11 9.16V2c-5 .5-9 4.79-9 10s4 9.5 9 " + "10v-7.16c-1-.41-2-1.52-2-2.84s1-2.43 " + "2-2.84zM14.86 11H22c-.48-4.75-4-8.53-9-9v7.16c1 " + ".3 1.52.98 1.86 1.84zM13 14.84V22c5-.47 8.52-4.25 " + "9-9h-7.14c-.34.86-.86 1.54-1.86 1.84z").attr("height", 10).attr("width", 10).attr("fill", reputation.badgeColour).attr("fill-opacity", reputation.reputation < threshold ? 0.5 : 1).attr("transform", "translate(" + "".concat(Math.min(172.5, Math.max(38.5, 30 + 150 * threshold / width)), ", ") + "".concat(10.65) + ")" + " scale(".concat(19.5 / 25, ")"));

            if (reputation.reputation < threshold) {
              badge.append("title").text("Next badge at ".concat(threshold));
            } else {
              badge.append("title").text("Obtained at ".concat(threshold));
            }
          });
          return container;
        }

        function mobileProgressView(reputation) {
          var container = document.createElement("div");
          container.classList.add("badge");
          var svg = select(container).append("svg").attr("viewBox", "0 0 200 40").append("g");
          svg.append("text").attr("data-val", reputation.reputation).attr("dominant-baseline", "central").attr("x", 10).attr("y", 20).attr("class", "fill-primary badge__reputation").attr("font-size", 16).text(0);

          if (reputation.badgeThresholds[reputation.badgeThresholds.length - 1] <= reputation.reputation) {
            var badge = svg.append("g");
            badge.append("path").attr("d", "M11 9.16V2c-5 .5-9 4.79-9 10s4 9.5 9 " + "10v-7.16c-1-.41-2-1.52-2-2.84s1-2.43 " + "2-2.84zM14.86 11H22c-.48-4.75-4-8.53-9-9v7.16c1 " + ".3 1.52.98 1.86 1.84zM13 14.84V22c5-.47 8.52-4.25 " + "9-9h-7.14c-.34.86-.86 1.54-1.86 1.84z").attr("height", 10).attr("width", 10).attr("fill", reputation.badgeColour).attr("fill-opacity", 1).attr("transform", "translate(" + "".concat(Math.min(172.5, Math.max(38.5, 30)), ", ") + "10.65" + ")" + " scale(".concat(19.5 / 25, ")"));
            badge.append("title").text("Obtained at ".concat(reputation.badgeThresholds[0]));
          } else {
            var idx = reputation.badgeThresholds.map(function (t, i) {
              return [t, i];
            ...
            if (idx == 0) {
              ...
              width = reputation.badgeThresholds[idx] - reputation.badgeThresholds[idx - 1];
              thresholds.push(reputation.badgeThresholds[idx - 1]);
            }

            thresholds.push(reputation.badgeThresholds[idx]);
            svg.append("rect").attr("x", 40).attr("y", 5).attr("height", 32).attr("width", 150).attr("rx", 16).attr("ry", 16).attr("stroke", "var(--reputation-colour)").attr("stroke-width", 1).attr("fill", "none");
            svg.append("rect").attr("class", "badge__bar").attr("x", 40).attr("y", 5 + Math.max(0, 16 - Math.sqrt(72 * Math.max(thresholds.length == 1 ? 0 : 32, 150 * (reputation.reputation - (thresholds.length == 1 ? 0 : thresholds[0])) / width)) / 2)).attr("height", Math.min(Math.sqrt(72 * Math.max(thresholds.length == 1 ? 0 : 32, 150 * (reputation.reputation - (thresholds.length == 1 ? 0 : thresholds[0])) / width)), 32)).attr("rx", 16).attr("ry", 16).attr("stroke", "var(--reputation-colour)").attr("stroke-width", 2).attr("fill", "var(--reputation-colour)");
            thresholds.forEach(function (threshold, i) {
              var badge = svg.append("g");
              badge.append("path").attr("d", "M11 9.16V2c-5 .5-9 4.79-9 10s4 9.5 9 " + "10v-7.16c-1-.41-2-1.52-2-2.84s1-2.43 " + "2-2.84zM14.86 11H22c-.48-4.75-4-8.53-9-9v7.16c1 " + ".3 1.52.98 1.86 1.84zM13 14.84V22c5-.47 8.52-4.25 " + "9-9h-7.14c-.34.86-.86 1.54-1.86 1.84z").attr("height", 10).attr("width", 10).attr("fill", reputation.badgeColour).attr("fill-opacity", reputation.reputation < threshold ? 0.5 : 1).attr("transform", "translate(" + "".concat(Math.min(155, Math.max(35, 30 + 150 * (i == 0 && thresholds.length > 1 ? 0 : threshold) / width)), ", ") + "2.5" + ")" + " scale(".concat(40 / 25, ")"));

              if (reputation.reputation < reputation.badgeThresholds[0]) {
                badge.append("title").text("Next badge at ".concat(reputation.badgeThresholds[0]));
              } else {
                badge.append("title").text("Obtained at ".concat(reputation.badgeThresholds[0]));
              }
            });
        ...
        function toggleDesktopReputationView() {
          var duration = 500;
          var counts = model.shadow.querySelectorAll(".badge__reputation");
          var bars = model.shadow.querySelectorAll(".badge__bar");

          var _loop = function _loop(i) {
            var reputation = model.reputations[i];
            ...
            if (model.element.open) {
              ...
              bar.transition().duration(duration).ease(cubicInOut).attr("width", Math.min(150 * reputation.reputation / width, 150));
            } else {
              count.transition().duration(duration).ease(cubicInOut).tween("text", function () {
              ...
              bar.transition().duration(duration).ease(cubicInOut).attr("width", 0);
            }
          };

          for (var i = 0; i < model.reputations.length; i++) {
            _loop(i);
          }
        }
        ...
        function toggleMobileReputationView() {
          ...
          var _loop2 = function _loop2(i) {
            ...
            if (model.element.open) {
              ...
              bar.transition().duration(duration).ease(cubicInOut).attr("width", Math.min(Math.max(thresholds.length == 1 ? 0 : 32, 150 * (reputation.reputation - (thresholds.length == 1 ? 0 : thresholds[0])) / width), 150));
            } else {
              count.transition().duration(duration).ease(cubicInOut).tween("text", function () {
                var interpolate = interpolateValue(this.textContent, 0); // eslint-disable-line
        ...
        function styleView() {
          ...
          style.setAttribute("href", window.location.protocol + "//" + window.location.host + "/static/reputation/css/header/student.min.css");
  ...
  return StudentReputationHeader;
}(ReputationHeader);
...
}((this['header/student'] = this['header/student'] || {})));
