...
function criterionView(criterion) {
  ...
  div.appendChild(options); // const versionLabel = document.createElement("label");
  ...
  weight.addEventListener("input", function () {
    return updateCriterionOption(criterion, weight);
  });
  ...
  otherOptions.forEach(function (o) {
    ...
    var input = createInput(option.type);
    input.name = option.name;
    input.value = option.value;
    input.addEventListener("input", function () {
      return updateCriterionOption(criterion, input);
    });
