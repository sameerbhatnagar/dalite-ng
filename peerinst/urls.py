...
urlpatterns = [
    ...
    url(
        r"^blink/(?P<pk>[0-9]+)/count/$", views.blink_count, name="blink-count"
    ),
    url(
        r"^blink/(?P<pk>[0-9]+)/close/$", views.blink_close, name="blink-close"
    ),
    url(
    ...
    url(
        r"^blink/(?P<pk>[0-9]+)/reset/$", views.blink_reset, name="blink-reset"
    ),
    url(
