...
urlpatterns = [
    ...
    url(r'^disciplines/create$', views.DisciplinesCreateView.as_view(), name='disciplines-create'),
    url(r'^disciplines/form$', views.disciplines_select_form, name='disciplines-form'),
    ...
    url(r'^password_reset/$', auth_views.password_reset, { 'html_email_template_name':'registration/password_reset_email_html.html' }, name='password_reset'),
    ...
    url(r'^blink/waiting/(?P<username>\w+)/$', views.blink_waiting, name='blink-waiting'),
    url(r'^blink/waiting/(?P<username>\w+)/(?P<assignment>[0-9]+)/$', views.blink_waiting, name='blink-waiting'),
