...
function _getRationales() {
  _getRationales = _asyncToGenerator(function* () {
    var data = {};
    var req = buildReq(data, "post");
    var resp = yield fetch(model.urls.rationales, req);
    var json = yield resp.json();
    model.rationales = json.rationales.map(function (rationale) {
      return {
...
function rationalesView() {
  var section = document.querySelector(".rationales");
...
function buildReq$1(data, method) {
  if (method.toLowerCase() === "get") {
    return {
      method: method.toUpperCase(),
      headers: {
        "Content-Type": "application/json",
        "X-CSRFToken": getCsrfToken$1()
      }
    };
  } else if (method.toLowerCase() === "post") {
    var body = data ? JSON.stringify(data) : "";
...
exports.initGradebooks = init$1;
exports.initMessages = init$3;
exports.initNotifications = init$2;
