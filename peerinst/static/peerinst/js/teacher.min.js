...
function notificationsView() {
  ...
  var completedNotifications = model.notifications.filter(function (notification) {
  ...
  if (model.notifications.some(function (notification) {
    return notification.inProgress;
  })) {
...
function getNotifications() {
  return model$1.tasks.map(function (task) {
    return {
      text: task.completed ? task.error ? "There was an error creating the gradebook for ".concat(task.description, ".") : "The gradebook for ".concat(task.description, " is ready.") : "Computing the gradebook for ".concat(task.description, "..."),
...
exports.initNotifications = init;
