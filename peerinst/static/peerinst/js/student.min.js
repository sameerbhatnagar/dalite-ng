...
function groupAssignmentsView(group) {
  ...
  if (group.assignments.length) {
    ...
    group.assignments.map(function (assignment) {
      return ul.appendChild(groupAssignmentView(assignment));
    });
    div.appendChild(ul);
  } else {
...
function addLinkListeners() {
  document.getElementById("edit-user-btn").addLinkListener("click", function () {
    edit_user();
  });
  document.getElementById("modify-tos-btn").addLinkListener("click", function () {
    modifyTos();
  });
}
