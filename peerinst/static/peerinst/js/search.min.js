...
function processResponse() {
  ...
  $("#progressbar").addClass("mdc-linear-progress--closed"); // Add filters based on search results
  ...
  $("#search_results .mdc-card").each(function (index) {
    ...
    if (!disciplineList.includes(d) & d.slice(1, -1) != "None") {
      ...
      $("#filter-on-discipline .mdc-chip-set").append("<div d=" + d + " class='mdc-chip' onclick='search.filter(this)' " + "tabindex='0' data-mdc-auto-init='MDCChip'>" + "<div class='mdc-chip__checkmark' >" + "<svg class='mdc-chip__checkmark-svg' viewBox='-2 -3 30 30'>" + "<path class='mdc-chip__checkmark-path' fill='none' stroke='black'" + "d='M1.73,12.91 8.1,19.28 22.79,4.59'/>" + "</svg>" + "</div>" + "<div class='mdc-chip__text'>" + d.slice(1, -1) + "</div>" + "</div>");
    }
  });
  ...
  $("#search_results .mdc-card").each(function () {
    ...
    $(list).each(function (i) {
      if (!categoryList.includes(list[i].toLowerCase()) & list[i] != "") {
        ...
        $("#filter-on-category .mdc-chip-set").append("<div c=" + list[i] + " class='mdc-chip' onclick='search.filter(this)' tabindex='0' " + "data-mdc-auto-init='MDCChip'>" + "<div class='mdc-chip__checkmark' >" + "<svg class='mdc-chip__checkmark-svg' viewBox='-2 -3 30 30'>" + "<path class='mdc-chip__checkmark-path' fill='none' " + "stroke='black'" + "d='M1.73,12.91 8.1,19.28 22.79,4.59'/>" + "</svg>" + "</div>" + "<div class='mdc-chip__text'>" + list[i] + "</div>" + "</div>");
      }
    });
  });
  ...
  console.info(endTimer - startTimer);
  console.info(endTimer);
}
/** Set up search
 *  @function
 */
