...
function init(assignUrl, unassignUrl, assignTrans, unassignTrans, collectionTitle, youHaveAssign, toText, youHaveUnassign, fromCollToGroup, groupUrl) {
  ...
  function clickAssign(el) {
    ...
    var dataObjAssigned = {
      message: youHaveAssign + collectionTitle + toText + el.getAttribute("name")
    };
  ...
  function clickUnassign(el) {
    ...
    var dataObjUnassigned = {
      message: youHaveUnassign + collectionTitle + "'" + fromCollToGroup + el.getAttribute("name")
    };
