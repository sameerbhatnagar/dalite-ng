...
class MDCChipSetFoundation extends MDCFoundation {
  ...
  handleChipInteraction_(evt) {
    ...
    if (this.adapter_.hasClass(cssClasses$3.CHOICE)) {
      ...
      chip.toggleSelected();
    } else if (this.adapter_.hasClass(cssClasses$3.FILTER)) {
...
var index$4 = Object.freeze({
	...
	MDCTemporaryDrawerFoundation: MDCTemporaryDrawerFoundation,
	MDCPersistentDrawer: MDCPersistentDrawer,
	MDCPersistentDrawerFoundation: MDCPersistentDrawerFoundation
});
...
class MDCSelectBottomLineFoundation extends MDCFoundation {
   ...
   */
  activate() {
    this.adapter_.addClass(cssClasses$10.BOTTOM_LINE_ACTIVE);
  }
   ...
   */
  deactivate() {
    this.adapter_.removeClass(cssClasses$10.BOTTOM_LINE_ACTIVE);
  }
...
class MDCSelect extends MDCComponent {
  ...
  initialize(
    ...
    this.nativeControl_ = this.root_.querySelector(strings$10.NATIVE_CONTROL_SELECTOR);
    const labelElement = this.root_.querySelector(strings$10.LABEL_SELECTOR);
    if (labelElement) {
      this.label_ = labelFactory(labelElement);
    }
    const bottomLineElement = this.root_.querySelector(strings$10.BOTTOM_LINE_SELECTOR);
    if (bottomLineElement) {
      this.bottomLine_ = bottomLineFactory(bottomLineElement);
    }

    if (this.root_.classList.contains(cssClasses$12.BOX)) {
...
class MDCTextFieldFoundation extends MDCFoundation {
  ...
  notchOutline(openNotch) {
    ...
    if (openNotch) {
      const isDense = this.adapter_.hasClass(cssClasses$13.DENSE);
  ...
  getDefaultFoundation() {
    return new MDCNotchedOutlineFoundation({
      ...
      setOutlinePathAttr: (value) => {
        const path = this.root_.querySelector(strings$13.PATH_SELECTOR);
        path.setAttribute('d', value);
      },
      getIdleOutlineStyleValue: (propertyName) => {
        const idleOutlineElement = this.root_.parentNode.querySelector(strings$13.IDLE_OUTLINE_SELECTOR);
...
class MDCTextField extends MDCComponent {
  ...
  initialize(
    ...
    this.input_ = this.root_.querySelector(strings$11.INPUT_SELECTOR);
    const labelElement = this.root_.querySelector(strings$11.LABEL_SELECTOR);
    if (labelElement) {
      this.label_ = labelFactory(labelElement);
    }
    const lineRippleElement = this.root_.querySelector(strings$11.BOTTOM_LINE_SELECTOR);
    if (lineRippleElement) {
      this.lineRipple_ = lineRippleFactory(lineRippleElement);
    }
    const outlineElement = this.root_.querySelector(strings$11.OUTLINE_SELECTOR);
    if (outlineElement) {
      this.outline_ = outlineFactory(outlineElement);
    }
    if (this.input_.hasAttribute(strings$11.ARIA_CONTROLS)) {
      const helperTextElement = document.getElementById(this.input_.getAttribute(strings$11.ARIA_CONTROLS));
      if (helperTextElement) {
        this.helperText_ = helperTextFactory(helperTextElement);
      }
    }
    const iconElement = this.root_.querySelector(strings$11.ICON_SELECTOR);
    if (iconElement) {
    ...
    return new MDCTextFieldFoundation(
      /** @type {!MDCTextFieldAdapter} */ (Object.assign({
        ...
        registerValidationAttributeChangeHandler: (handler) => {
          ...
          const targetNode = this.root_.querySelector(strings$11.INPUT_SELECTOR);
        ...
        isFocused: () => {
          return document.activeElement === this.root_.querySelector(strings$11.INPUT_SELECTOR);
        },
...
var bisectRight$2 = ascendingBisect$1.right;
...
var t0$2 = 4 / 29;
var t1$2 = 6 / 29;
var t2$2 = 3 * t1$2 * t1$2;
var t3$2 = t1$2 * t1$2 * t1$2;
...
var tau$5 = 2 * pi$5;
var epsilon$3 = 1e-6;
var tauEpsilon$1 = tau$5 - epsilon$3;
...
var Quad$1 = function(node, x0, y0, x1, y1) {
  this.node = node;
  this.x0 = x0;
  this.y0 = y0;
  this.x1 = x1;
...
function continuous(deinterpolate, reinterpolate) {
  ...
  scale.domain = function(_) {
    return arguments.length ? (domain = map$6.call(_, number$4), rescale()) : domain.slice();
  };
...
var formatLocale$1 = function(locale) {
  var group = locale.grouping && locale.thousands ? formatGroup$1(locale.grouping, locale.thousands) : identity$9,
      currency = locale.currency,
      decimal = locale.decimal,
      numerals = locale.numerals ? formatNumerals$1(locale.numerals) : identity$9,
      percent = locale.percent || "%";
...
function calendar(year$$1, month$$1, week, day$$1, hour$$1, minute$$1, second$$1, millisecond$$1, format) {
  ...
  scale.domain = function(_) {
    return arguments.length ? domain(map$6.call(_, number$5)) : domain().map(date$2);
  };
...
var selection_data$2 = function(value, key) {
  ...
  if (typeof value !== "function") value = constant$14(value);
...
var defaultView$2 = function(node) {
  return (node.ownerDocument && node.ownerDocument.defaultView) // node is a Node
      || (node.document && node) // node is a Window
      || node.defaultView; // node is a Document
};
...
var selection_clone$2 = function(deep) {
...
var selectAll$2 = function(selector) {
  return typeof selector === "string"
      ...
      : new Selection$3([selector == null ? [] : selector], root$3);
};
...
var line = function() {
  ...
  line.x = function(_) {
    return arguments.length ? (x$$1 = typeof _ === "function" ? _ : constant$15(+_), line) : x$$1;
  };

  line.y = function(_) {
    return arguments.length ? (y$$1 = typeof _ === "function" ? _ : constant$15(+_), line) : y$$1;
  };

  line.defined = function(_) {
    return arguments.length ? (defined = typeof _ === "function" ? _ : constant$15(!!_), line) : defined;
  };
...
var area$2 = function() {
  ...
  area.x = function(_) {
    return arguments.length ? (x0 = typeof _ === "function" ? _ : constant$15(+_), x1 = null, area) : x0;
  };

  area.x0 = function(_) {
    return arguments.length ? (x0 = typeof _ === "function" ? _ : constant$15(+_), area) : x0;
  };

  area.x1 = function(_) {
    return arguments.length ? (x1 = _ == null ? null : typeof _ === "function" ? _ : constant$15(+_), area) : x1;
  };

  area.y = function(_) {
    return arguments.length ? (y0 = typeof _ === "function" ? _ : constant$15(+_), y1 = null, area) : y0;
  };

  area.y0 = function(_) {
    return arguments.length ? (y0 = typeof _ === "function" ? _ : constant$15(+_), area) : y0;
  };

  area.y1 = function(_) {
    return arguments.length ? (y1 = _ == null ? null : typeof _ === "function" ? _ : constant$15(+_), area) : y1;
  };
  ...
  area.defined = function(_) {
    return arguments.length ? (defined = typeof _ === "function" ? _ : constant$15(!!_), area) : defined;
  };
...
MonotoneX.prototype = {
  ...
  lineEnd: function() {
    switch (this._point) {
      ...
      case 3: point$7(this, this._t0, slope2(this, this._t0)); break;
    }
    if (this._line || (this._line !== 0 && this._point === 1)) this._context.closePath();
    this._line = 1 - this._line;
  },
  point: function(x, y) {
    ...
    switch (this._point) {
      ...
      case 2: this._point = 3; point$7(this, slope2(this, t1 = slope3(this, x, y)), t1); break;
      default: point$7(this, this._t0, t1 = slope3(this, x, y)); break;
    }
...
var selection_data$3 = function(value, key) {
  ...
  if (typeof value !== "function") value = constant$16(value);
...
var selection_join$2 = function(onenter, onupdate, onexit) {
  var enter = this.enter(), update = this, exit = this.exit();
  enter = typeof onenter === "function" ? onenter(enter) : enter.append(onenter + "");
  if (onupdate != null) update = onupdate(update);
  if (onexit == null) exit.remove(); else onexit(exit);
...
var defaultView$3 = function(node) {
  return (node.ownerDocument && node.ownerDocument.defaultView) // node is a Node
      || (node.document && node) // node is a Window
      || node.defaultView; // node is a Document
};
...
var selection_clone$3 = function(deep) {
...
Selection$4.prototype = selection$6.prototype = {
...
var clockNow$2 = 0;
var clockSkew$2 = 0;
var clock$2 = typeof performance === "object" && performance.now ? performance : Date;
var setFrame$2 = typeof window === "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(f) { setTimeout(f, 17); };
...
var emptyOn$1 = dispatch$6("start", "end", "interrupt");
var emptyTween$1 = [];
...
var t0$5 = 4 / 29;
var t1$5 = 6 / 29;
var t2$3 = 3 * t1$5 * t1$5;
var t3$3 = t1$5 * t1$5 * t1$5;
...
function gamma$2(y) {
  return (y = +y) === 1 ? nogamma$2 : function(a, b) {
    return b - a ? exponential$3(a, b, y) : constant$17(isNaN(a) ? b : a);
  };
}

function nogamma$2(a, b) {
  var d = b - a;
  return d ? linear$5(a, d) : constant$17(isNaN(a) ? b : a);
}
...
function parseCss$2(value) {
  if (value === "none") return identity$11;
...
var transition_attr$1 = function(name, value) {
  var fullname = namespace$3(name), i = fullname === "transform" ? interpolateTransformSvg$2 : interpolate$2;
  return this.attrTween(name, typeof value === "function"
...
function durationFunction$1(id, value) {
  return function() {
    set$8(this, id).duration = +value.apply(this, arguments);
  };
}

function durationConstant$1(id, value) {
  return value = +value, function() {
    set$8(this, id).duration = value;
  };
}
...
function onFunction$1(id, name, listener) {
  var on0, on1, sit = start$2(name) ? init$1 : set$8;
  return function() {
...
var transition_select$1 = function(select) {
  var name = this._name,
      id = this._id;
...
var transition_selectAll$1 = function(select) {
  var name = this._name,
      id = this._id;
...
var Selection$5 = selection$6.prototype.constructor;
...
function transition$1(name) {
  return selection$6().transition(name);
}
...
var selection_prototype$1 = selection$6.prototype;
...
selection$6.prototype.interrupt = selection_interrupt$1;
selection$6.prototype.transition = selection_transition$1;

var root$5 = [null];

var active$1 = function(node, name) {
  var schedules = node.__transition,
      schedule,
      i;
  ...
  if (schedules) {
    ...
    for (i in schedules) {
      if ((schedule = schedules[i]).state > SCHEDULED$1 && schedule.name === name) {
        return new Transition$1([[node]], root$5, name, +i);
      }
    }
  }
...
mdcAutoInit.register("MDCDrawer", MDCTemporaryDrawer);
...
function underlines() {
  ...
  var lines = selectAll$2(".underline");
...
function plotTimeSeries(el, d) {
  ...
  var x = time().domain([new Date(timeParse$1(d.distribution_date)), new Date(timeParse$1(d.due_date))]).range([0, width]);
  var y = linear$4().domain([0, d.total]).range([height, 0]);
  ...
  var format = timeFormat$1("%c");
  var f = line().x(function (d) {
    return x(new Date(timeParse$1(d)));
  }).y(function (d, i) {
    return y(i + 1);
  }).curve(stepAfter);
  ...
  if (d.due_date > d.last_login) {
    var endDate = Math.min(new Date(timeParse$1(d.now)), new Date(timeParse$1(d.due_date)));
    g.append("rect").attr("stroke", "black").attr("stroke-width", "1px").attr("fill", "gray").style("opacity", 0.2).attr("x", function () {
      return x(new Date(timeParse$1(d.last_login)));
    }).attr("y", function () {
      return 0;
    }).attr("width", function () {
      return x(endDate) - x(new Date(timeParse$1(d.last_login)));
    }).attr("height", height);
  }
  ...
  g.append("text").attr("x", width).attr("dx", -5).attr("y", -25).attr("text-anchor", "end").style("font-size", "10px").style("font-family", "sans-serif").text(format(new Date(timeParse$1(d.due_date))));
  g.append("text").attr("x", 0).attr("dx", 5).attr("y", -25).attr("text-anchor", "start").style("font-size", "10px").style("font-family", "sans-serif").text(format(new Date(timeParse$1(d.distribution_date))));
  ...
  var area = area$2().x0(f.x()).y0(height).x1(f.x()).y1(f.y()).curve(stepAfter);
  svg.on("mousemove",
  /* @this */
  function () {
    var xValue = Math.min(mouse$2(this)[0], 1 + x(max(d.answers.map(function (x) {
      return new Date(timeParse$1(x));
    }))));
...
exports.scaleLinear = linear$4;
exports.scaleOrdinal = ordinal;
exports.select = select$2;
exports.selectAll = selectAll$2;
