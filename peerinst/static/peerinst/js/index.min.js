...
function bindAjaxTextInputForm(idToBind, formToReplace, createUrl, formUrl, init, searchUrl) {
...
function categoryForm(idToBind, formToReplace, createUrl, formUrl, init, searchUrl) {
  // Define ENTER key
  ...
  $("#clear_category_form").click(function () {
    $("#category_form").load(formUrl, function () {
      bundle.bindAjaxTextInputForm(idToBind, formToReplace, createUrl, formUrl, init, searchUrl);
  ...
  $("#submit_category_form").click(function () {
    ...
    posting.success(function (data, status) {
      ...
      if (formType.length) {
        categoryForm(idToBind, formToReplace, createUrl, formUrl, init, searchUrl);
        bundle.autoInit();
...
function disciplineForm(idToBind, formToReplace, createUrl, formUrl, init, searchUrl) {
  ...
  $("#submit_discipline_form").click(function () {
    ...
    posting.success(function (data, status) {
      ...
      if (formType.length) {
        disciplineForm(idToBind, formToReplace, createUrl, formUrl, init, searchUrl);
        bundle.autoInit();
      } else {
        bundle.bindAjaxTextInputForm(idToBind, formToReplace, createUrl, formUrl, init, searchUrl);
      }
