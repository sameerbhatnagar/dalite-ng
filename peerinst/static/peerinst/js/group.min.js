...
function _saveTextField() {
  _saveTextField = _asyncToGenerator(
  /*#__PURE__*/
  regenerator.mark(function _callee(field, save, className, url) {
    var newField, name, newValue, err;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            newValue = field.firstChild.value;
            _context.next = 8;
            return updateDetails(name, newValue, url);
          ...
          case 13:
            return _context.abrupt("return", newField);
...
function _saveTextListField() {
  _saveTextListField = _asyncToGenerator(
  /*#__PURE__*/
  regenerator.mark(function _callee2(field, save, className, url) {
    var newField, name, ul, li, newValue, err, li_;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            name = field.getAttribute("name");
            newField.setAttribute("name", name);
            ul = field.firstChild.cloneNode(true);
            li = field.firstChild.lastChild;
          ...
          case 12:
            newField.append(ul);
            return _context2.abrupt("return", newField);
...
function _saveDateTimeField() {
  _saveDateTimeField = _asyncToGenerator(
  /*#__PURE__*/
  regenerator.mark(function _callee3(field, save, className, url) {
    var newField, name, sentValue, newValue, err;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            sentValue = field.firstChild.value;
            newValue = flatpickr.formatDate(new Date(sentValue), "Y-m-d H:i");
            _context3.next = 9;
            return updateDetails(name, sentValue, url);
          ...
          case 14:
            return _context3.abrupt("return", newField);
...
function _updateDetails() {
  _updateDetails = _asyncToGenerator(
  /*#__PURE__*/
  regenerator.mark(function _callee4(name, value, url) {
    var data, token, req, resp, err;
