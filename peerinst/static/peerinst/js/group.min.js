var group = (function (exports,flatpickr) {
'use strict';
...
function _createCollection() {
  _createCollection = _asyncToGenerator(function* (groupPk, addAssignmentUrl, collectionUpdateUrl) {
    ...
    window.location.replace(collectionUpdateUrl.replace("0", "".concat(data.pk)));
  });
  return _createCollection.apply(this, arguments);
}
...
function createSvg(name) {
  ...
  if (useSprite) {
    use.setAttributeNS("http://www.w3.org/1999/xlink", "href", "#".concat(name));
  } else {
...
exports.toggleStudentIdNeeded = toggleStudentIdNeeded;
